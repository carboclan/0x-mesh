...
func TestConfigChainIDAndRPCMatchDetection(t *testing.T) {
	...
	config := Config{
		...
		EthereumRPCMaxContentLength:      131072,
...
func TestOrderSync(t *testing.T) {
	...
	originalOrders := scenario.NewSignedTestOrdersBatch(t, paginationSubprotocolPerPage+1, orderOptions)
